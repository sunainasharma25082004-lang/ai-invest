...
const pickerText = {
  en: {
    ...
    selectSubtitle: 'Select English or Arabic — Google Translate will translate the admin panel',
    english: 'English',
    arabic: 'العربية',
    continue: 'Continue',
  ...
  ar: {
    ...
    selectSubtitle: 'حدد الإنجليزية أو العربية — سيترجم Google Translate لوحة الإدارة',
    english: 'English',
    arabic: 'العربية',
    continue: 'متابعة',
      ...
      <div className="glass-card w-full max-w-md animate-fade-up rounded-2xl p-6 shadow-2xl shadow-cyan-500/10 sm:p-8">
        ...
        <div className="mt-8 grid grid-cols-2 gap-3 sm:gap-4">
          ...
          >
            ...
            <p className="mt-2 text-sm font-semibold text-white sm:text-base">{text.english}</p>
          </button>
          ...
          >
            <span className="text-2xl">🇸🇦</span>
            <p className="mt-2 text-sm font-semibold text-white sm:text-base">{text.arabic}</p>
          </button>
        </div>

        <button
          type="button"
          onClick={() => void confirmLanguage()}
          disabled={isTranslating}
